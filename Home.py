...
def main():
    ...
    if calculate_percent_scored_voters(data) < 100:
        st.warning('Matching distribution download is not recommended until 100% of addresses are scored. This could take up to 48 hours after the round concludes.')
